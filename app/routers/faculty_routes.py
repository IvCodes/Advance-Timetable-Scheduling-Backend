...
# @router.get("/faculty/unavailable-days/{faculty_id}", response_model=List[UnavailabilityRecord])
...
# @router.post("/faculty/unavailable-days", response_model=UnavailabilityRecord)
...
#         if unavailable.get("date") == request.date.isoformat():
...
#     unavailable_dates.append(unavailability.model_dump())
...
# @router.delete("/faculty/unavailable-days/{faculty_id}/{unavailable_date}")
...
# @router.get("/faculty/unavailability/pending", response_model=List[dict])
...
# @router.put("/faculty/unavailability/{faculty_id}/{unavailable_date}", response_model=UnavailabilityRecord)
...
async def initialize_unavailable_dates():
    """
