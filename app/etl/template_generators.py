...
def generate_activity_template():
    """Generate a template Excel file for Activities"""
    data = {
...
def generate_module_template():
    """Generate a template Excel file for Modules"""
    data = {
...
def generate_space_template():
    """Generate a template Excel file for Spaces"""
    data = {
...
def generate_year_template():
    """Generate a template Excel file for Years and Subgroups"""
    data = {
...
def get_template_generator(entity_type: str):
    ...
    return generators.get(entity_type)